...
FC_REFLECT(uosio::chain::permission_level_weight, (permission)(weight) )
FC_REFLECT(uosio::chain::key_weight, (key)(weight) )
FC_REFLECT(uosio::chain::wait_weight, (wait_sec)(weight) )
FC_REFLECT(uosio::chain::authority, (threshold)(keys)(accounts)(waits) )
FC_REFLECT(uosio::chain::shared_authority, (threshold)(keys)(accounts)(waits) )
