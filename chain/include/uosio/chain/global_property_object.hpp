...
#include <uosio/chain/incremental_merkle.hpp>
...
CHAINBASE_SET_INDEX_TYPE(uosio::chain::global_property_object, uosio::chain::global_property_multi_index)
CHAINBASE_SET_INDEX_TYPE(uosio::chain::dynamic_global_property_object,
                         uosio::chain::dynamic_global_property_multi_index)

FC_REFLECT(uosio::chain::dynamic_global_property_object,
           (global_action_sequence)
          )

FC_REFLECT(uosio::chain::global_property_object,
