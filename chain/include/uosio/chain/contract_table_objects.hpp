...
#include <uosio/chain/multi_index_includes.hpp>
...
CHAINBASE_SET_INDEX_TYPE(uosio::chain::table_id_object, uosio::chain::table_id_multi_index)
CHAINBASE_SET_INDEX_TYPE(uosio::chain::key_value_object, uosio::chain::key_value_index)

CHAINBASE_SET_INDEX_TYPE(uosio::chain::index64_object, uosio::chain::index64_index)
CHAINBASE_SET_INDEX_TYPE(uosio::chain::index128_object, uosio::chain::index128_index)
CHAINBASE_SET_INDEX_TYPE(uosio::chain::index256_object, uosio::chain::index256_index)
CHAINBASE_SET_INDEX_TYPE(uosio::chain::index_double_object, uosio::chain::index_double_index)
CHAINBASE_SET_INDEX_TYPE(uosio::chain::index_long_double_object, uosio::chain::index_long_double_index)

FC_REFLECT(uosio::chain::table_id_object, (id)(code)(scope)(table) )
FC_REFLECT(uosio::chain::key_value_object, (id)(t_id)(primary_key)(value)(payer) )
