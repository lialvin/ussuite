...
CHAINBASE_SET_INDEX_TYPE(uosio::chain::permission_object, uosio::chain::permission_index)
CHAINBASE_SET_INDEX_TYPE(uosio::chain::permission_usage_object, uosio::chain::permission_usage_index)

FC_REFLECT(chainbase::oid<uosio::chain::permission_object>, (_id))
FC_REFLECT(uosio::chain::permission_object, (id)(usage_id)(parent)(owner)(name)(last_updated)(auth))

FC_REFLECT(chainbase::oid<uosio::chain::permission_usage_object>, (_id))
FC_REFLECT(uosio::chain::permission_usage_object, (id)(last_used))
