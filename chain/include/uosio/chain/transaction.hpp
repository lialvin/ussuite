...
FC_REFLECT( uosio::chain::transaction_header, (expiration)(ref_block_num)(ref_block_prefix)
                                              (max_net_usage_words)(max_cpu_usage_ms)(delay_sec) )
FC_REFLECT_DERIVED( uosio::chain::transaction, (uosio::chain::transaction_header), (context_free_actions)(actions)(transaction_extensions) )
FC_REFLECT_DERIVED( uosio::chain::signed_transaction, (uosio::chain::transaction), (signatures)(context_free_data) )
FC_REFLECT_ENUM( uosio::chain::packed_transaction::compression_type, (none)(zlib))
FC_REFLECT( uosio::chain::packed_transaction, (signatures)(compression)(packed_context_free_data)(packed_trx) )
FC_REFLECT_DERIVED( uosio::chain::deferred_transaction, (uosio::chain::signed_transaction), (sender_id)(sender)(payer)(execute_after) )
FC_REFLECT( uosio::chain::deferred_reference, (sender)(sender_id) )
