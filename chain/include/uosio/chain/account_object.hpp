...
namespace uosio { namespace chain {
   ...
   class account_object : public chainbase::object<account_object_type, account_object> {
      ...
      void set_abi( const uosio::chain::abi_def& a ) {
         abi.resize( fc::raw::pack_size( a ) );
         fc::datastream<char*> ds( abi.data(), abi.size() );
         fc::raw::pack( ds, a );
      }

      uosio::chain::abi_def get_abi()const {
         uosio::chain::abi_def a;
         UOS_ASSERT( abi.size() != 0, abi_not_found_exception, "No ABI set on account ${n}", ("n",name) );
...
CHAINBASE_SET_INDEX_TYPE(uosio::chain::account_object, uosio::chain::account_index)
CHAINBASE_SET_INDEX_TYPE(uosio::chain::account_sequence_object, uosio::chain::account_sequence_index)


FC_REFLECT(uosio::chain::account_object, (name)(vm_type)(vm_version)(code_version)(code)(creation_date))
