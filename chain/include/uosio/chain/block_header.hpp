...
FC_REFLECT(uosio::chain::block_header, 
           (timestamp)(producer)(confirmed)(previous)
           (transaction_mroot)(action_mroot)
           (schedule_version)(new_producers)(header_extensions))

FC_REFLECT_DERIVED(uosio::chain::signed_block_header, (uosio::chain::block_header), (producer_signature))
FC_REFLECT(uosio::chain::header_confirmation,  (block_id)(producer)(producer_signature) )
