...
CHAINBASE_SET_INDEX_TYPE(uosio::chain::producer_object, uosio::chain::producer_multi_index)

FC_REFLECT(uosio::chain::producer_object::id_type, (_id))
FC_REFLECT(uosio::chain::producer_object, (id)(owner)(last_aslot)(signing_key)(total_missed)(last_confirmed_block_num)
           (configuration))
