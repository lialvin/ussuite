...
CHAINBASE_SET_INDEX_TYPE(uosio::chain::permission_link_object, uosio::chain::permission_link_index)

FC_REFLECT(uosio::chain::permission_link_object, (id)(account)(code)(message_type)(required_permission))
