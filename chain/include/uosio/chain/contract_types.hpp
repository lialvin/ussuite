...
using action_name    = uosio::chain::action_name;
...
FC_REFLECT( uosio::chain::newaccount                       , (creator)(name)(owner)(active) )
FC_REFLECT( uosio::chain::setcode                          , (account)(vmtype)(vmversion)(code) )
FC_REFLECT( uosio::chain::setabi                           , (account)(abi) )
FC_REFLECT( uosio::chain::updateauth                       , (account)(permission)(parent)(auth) )
FC_REFLECT( uosio::chain::deleteauth                       , (account)(permission) )
FC_REFLECT( uosio::chain::linkauth                         , (account)(code)(type)(requirement) )
FC_REFLECT( uosio::chain::unlinkauth                       , (account)(code)(type) )
FC_REFLECT( uosio::chain::canceldelay                      , (canceling_auth)(trx_id) )
FC_REFLECT( uosio::chain::onerror                          , (sender_id)(sent_trx) )
FC_REFLECT( uosio::chain::vote_producer					   , (producer)(voted) )
