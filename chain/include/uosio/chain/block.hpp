#pragma once
#include <uosio/chain/block_header.hpp>
...
FC_REFLECT_ENUM( uosio::chain::transaction_receipt::status_enum,
                 (executed)(soft_fail)(hard_fail)(delayed)(expired) )

FC_REFLECT(uosio::chain::transaction_receipt_header, (status)(cpu_usage_us)(net_usage_words) )
FC_REFLECT_DERIVED(uosio::chain::transaction_receipt, (uosio::chain::transaction_receipt_header), (trx) )
FC_REFLECT_DERIVED(uosio::chain::signed_block, (uosio::chain::signed_block_header), (transactions)(block_extensions) )
