...
namespace fc {
  ...
  namespace crypto { namespace sm2 {
    namespace detail
    {
  ...
  namespace raw
  {
      ...
      void unpack( Stream& s, fc::crypto::sm2::public_key& pk)
      {
          crypto::sm2::public_key_data ser;
          fc::raw::unpack(s,ser);
          pk = fc::crypto::sm2::public_key( ser );
      }

      template<typename Stream>
      void pack( Stream& s, const fc::crypto::sm2::public_key& pk)
      {
          fc::raw::pack( s, pk.serialize() );
      }

      template<typename Stream>
      void unpack( Stream& s, fc::crypto::sm2::private_key& pk)
      {
          fc::sha256 sec;
          unpack( s, sec );
          pk = crypto::sm2::private_key::regenerate(sec);
      }

      template<typename Stream>
      void pack( Stream& s, const fc::crypto::sm2::private_key& pk)
      {
...
FC_REFLECT_TYPENAME( fc::crypto::sm2::private_key )
FC_REFLECT_TYPENAME( fc::crypto::sm2::public_key )
FC_REFLECT_DERIVED( fc::crypto::sm2::public_key_shim, (fc::crypto::shim<fc::crypto::sm2::public_key_data>), BOOST_PP_SEQ_NIL )
FC_REFLECT_DERIVED( fc::crypto::sm2::signature_shim, (fc::crypto::shim<fc::crypto::sm2::compact_signature>), BOOST_PP_SEQ_NIL )
FC_REFLECT_DERIVED( fc::crypto::sm2::private_key_shim, (fc::crypto::shim<fc::crypto::sm2::private_key_secret>), BOOST_PP_SEQ_NIL )
