...
namespace fc { namespace ecc {
    ...
    compact_signature private_key::sign_compact( const fc::sha256& digest, bool require_canonical )const
    {
        ...
        //std::cout<<"  digest="<< fc::to_hex(digest.data(),32) <<"  key=" <<fc::to_hex((const char*) my->_key.data(),33 ) <<std::endl;
        do
        {
        ...
        //std::cout<<"  sig bin hex=" << fc::to_hex((const char*)result.begin() ,66) <<"  " <<std::endl;
        return result;
    }
